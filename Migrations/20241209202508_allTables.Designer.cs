...
namespace BarberShop.Migrations
{
    ...
    [Migration("20241209202508_allTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CalisanIslem", b =>
                {
                    b.HasOne("BarberShop.Models.Calisan", null)
                        .WithMany()
                        .HasForeignKey("CalisanlarCalisanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BarberShop.Models.Islem", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BarberShop.Models.Kullanici", null)
                        .WithMany()
